 ...
 * @author Leonardo
 */
public class ConsultaForma extends javax.swing.JDialog {
    VendaCompra vendaC = new VendaCompra();
    ValidaNivelUsuario valida = new ValidaNivelUsuario();
    TeclasdeAtalho atalho = new TeclasdeAtalho();
    
    /**
     * Creates new form ConsultaForma
     */
    public ConsultaForma(java.awt.Frame telaOrigem, boolean modal) {
    ...
    private void initComponents() {
        ...
        jBtCadastrarNova.setName("CADASTRAR FORMA DE PAGAMENTO"); // NOI18N
    ...
    private void jBtPesquisarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtPesquisarActionPerformed
        ...
        switch (jComboBoxConsulta.getSelectedIndex()){
            case 0 :
                preencher.PreencherJtableGenerico(jTableConsulta, vendaC.getForma().consultarGeral());
            break; 
            
            case 1 :
                try{
                    vendaC.getForma().setCdForma(Integer.parseInt(jTextFieldConsulta.getText()));
                    preencher.PreencherJtableGenerico(jTableConsulta, vendaC.getForma().consultarCodigo(vendaC.getForma()));
            ...
            default :
                vendaC.getForma().setDsForma(jTextFieldConsulta.getText().toUpperCase());
                preencher.PreencherJtableGenerico(jTableConsulta, vendaC.getForma().consultarDsForma(vendaC.getForma()));
        }
        if (preencher.Vazia()){
...
//            java.util.logging.Logger.getLogger(ConsultaForma.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//            public void run() {
//                new ConsultaForma().setVisible(true);
//            }
//        });
//    }
