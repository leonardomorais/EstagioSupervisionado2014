...
public class Fornecedor {
    ...
    public ResultSet consultarGeral() {
        String sql = "SELECT FN.CD_PESSOA, P.NOME, CASE WHEN P.TP_PESSOA = 'F' "
    ...
    public ResultSet consultarCdFornecedor(Fornecedor fornecedor) {
        String sql = "SELECT FN.CD_PESSOA, P.NOME, CASE WHEN P.TP_PESSOA = 'F' "
                + "THEN 'FÍSICA' ELSE 'JURÍDICA' END AS TIPO, "
                + "CASE WHEN P.TP_PESSOA = 'J' "
                + "THEN "
    ...
    public ResultSet consultarNomeFornecedor(Fornecedor fornecedor) {
        String sql = "SELECT FN.CD_PESSOA, P.NOME, CASE WHEN P.TP_PESSOA = 'F' "
                + "THEN 'FÍSICA' ELSE 'JURÍDICA' END AS TIPO, "
                + "CASE WHEN P.TP_PESSOA = 'J' "
                + "THEN "
